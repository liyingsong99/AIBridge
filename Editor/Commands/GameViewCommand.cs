    ...
    public class GameViewCommand : ICommand
    {
        ...
        private bool TryInitReflection(out string error)
        {
            ...
            try
            {
                ...
                // GameView
                _getMainGameView = _gameViewType.GetMethod("GetMainGameView",
                    BindingFlags.NonPublic | BindingFlags.Static);
                _selectedSizeIndex = _gameViewType.GetProperty("selectedSizeIndex",
                    BindingFlags.NonPublic | BindingFlags.Instance);

                // GameViewSizes
                _sizesInstance = _gameViewSizesType.GetProperty("instance",
                    BindingFlags.Public | BindingFlags.Static);
                _currentGroupType = _gameViewSizesType.GetProperty("currentGroupType",
                    BindingFlags.Public | BindingFlags.Static);
                ...
                if (_sizesInstance == null || _getGroup == null || _getTotalCount == null ||
                    _getGameViewSize == null || _sizeWidth == null || _sizeHeight == null)
                {
                    _reflectionError = "Some GameView internal members not found. This Unity version may not be supported.";
                    error = _reflectionError;
                    return false;
                }
        ...
        {
            if (_getMainGameView == null) return null;
