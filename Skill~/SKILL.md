...
- Code Index is optional. For C# semantic lookup use `aibridge-code-index` only when installed and enabled; for literal, non-C#, asset, scene, prefab, or unavailable Code Index searches use your host's own search/read tools and regular AIBridge commands.
