...
| Code Index | Read-only C# declaration-name lookup and file-location evidence | Runtime state, asset mutation, project build validation, or whole-project relationship analysis |
...
- Prefer verification gates that can be repeated: compile, tests, logs, screenshots, Runtime calls, or declaration-name lookup.
